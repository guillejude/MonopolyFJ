...
public class GameMasterTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        gameMaster.setInitAmountOfMoney(1500);
    ...
    public void testBtnGetOutOfJailClicked(){
        ...
        assertFalse(gameMaster.getGUI().isGetOutOfJailButtonEnabled());
    }
    
    public void testBtnGetOutOfJailClickedBankrupt(){
        gameMaster.getCurrentPlayer().setInJail(true);
        gameMaster.getCurrentPlayer().setMoney(0);
        gameMaster.btnGetOutOfJailClicked();
